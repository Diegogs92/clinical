        ...
        <div className="flex items-start justify-between gap-4 pb-4 border-b border-elegant-200/70 dark:border-elegant-800/70">
          <div className="space-y-1">
            ...
            <p className="text-xs text-elegant-500 dark:text-elegant-400">
              {/* spacer for alignment when no subtitle */}
            </p>
          </div>
          <button
            onClick={onClose}
            className="inline-flex items-center justify-center w-9 h-9 rounded-full text-elegant-500 hover:text-elegant-800 hover:bg-elegant-100 dark:text-elegant-300 dark:hover:text-white dark:hover:bg-elegant-800 transition"
