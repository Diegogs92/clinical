...
export default function Modal({
  ...
  const modalContent = (
    <div
      className={`fixed inset-0 z-[9998] flex items-center justify-center p-4 bg-black/40 backdrop-blur-md transition-opacity duration-[180ms] ${
    ...
    >
      ...
      <div
        className={`relative w-full ${maxWidth} max-h-[85vh] bg-white dark:bg-elegant-900 rounded-2xl shadow-xl border border-elegant-200/60 dark:border-elegant-800/60 overflow-hidden flex flex-col transition-all duration-[180ms] ${
