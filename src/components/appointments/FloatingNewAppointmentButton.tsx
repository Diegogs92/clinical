  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-40 md:bottom-24 right-6 bg-gradient-to-br from-primary to-primary-light hover:from-primary-dark hover:to-primary text-white rounded-full p-4 shadow-lg hover:shadow-xl hover:shadow-primary/30 transition-all duration-200 hover:scale-105 active:scale-100 z-[100] flex items-center gap-3 group"
